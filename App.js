          ...
          <AuthProvider>
            <AlertProvider>
              ...
              <View style={{ flex: 1, backgroundColor: BRAND, direction: 'ltr' }}>
                {/* Wrap the entire navigator in an ErrorBoundary so that
                    uncaught errors in any screen don't crash the whole app.
                    Instead, the ErrorBoundary will render a fallback UI and
                    help surface the issue gracefully. */}
                <ErrorBoundary>
                  <AppNavigator />
                </ErrorBoundary>
              </View>
