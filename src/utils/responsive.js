...
export const scale = (size) => PixelRatio.roundToNearestPixel(size * scaleFactorW);

export const verticalScale = (size) => PixelRatio.roundToNearestPixel(size * scaleFactorH);
